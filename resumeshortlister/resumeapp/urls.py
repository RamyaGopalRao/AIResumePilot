...
from .views.resume_views import resume_list,resume_education,resume_experience,shortlist_resumes,upload_resumes,resume_list_data
...
urlpatterns = [
    ...
    path('resumes/', resume_list_data, name='resume_list'),
